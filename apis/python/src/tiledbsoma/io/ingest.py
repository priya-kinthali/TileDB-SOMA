...
def _write_dataframe(
    ...
    *,
    ...
    This function adds a `soma_joinid` index to the provided pd.DataFrame, as that is required by
    libtiledbsoma; the original pd.DataFrame index is "reset" to a column, with its original name
    stored as metadata on the SOMA DataFrame.
